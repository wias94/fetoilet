...
/**
 * Active backend: real **Neon** when `DATABASE_URL` is set at runtime.
 * Do not snapshot process.env.DATABASE_URL at build — Vite would inline
 * `undefined` and Railway would keep looking for PGLite.
 */
